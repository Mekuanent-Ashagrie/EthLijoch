            ...
            <div className="top-bar-2 fx">
              <div id="site-logo" className="clearfix">
                <Link href="/">
                  <a className="logo st-2">
                    <img src="assets/images/EthLijochImage/logo.png" alt="Kinco" />
                  </a>
                </Link>
              </div>
              <div className="header-contact fx">
                <div className="inner-contact fx">
                  ...
                  <ul>
                    <li className="clr-pri-4">የቢሮ አድራሻችን</li>
                    <li className="clr-pri-2">ሠተማ ህንጻ 1ኛ ፎቅ፣ አዲስ አበባ</li>
                  </ul>
                </div>
                <div className="inner-contact fx">
                  <svg
                  ...
                  <ul>
                    <li className="clr-pri-4">ስልክ</li>
                    <li className="clr-pri-2">+251 (111) 67348</li>
                  </ul>
                </div>
                <a
                  href="#"
