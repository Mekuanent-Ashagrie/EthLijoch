                      ...
                      <div className="item-slider-1">
                        <div className="box-content">
                          ...
                          <div className="box-custom">
                            <div className="wrap clr-pri-1">የኢትዮጵያ ልጆች</div>
                            <svg
                              data-name="Hero Area"
                          ...
                          <ul>
                            <li className="st-1 fx">
                              ...
                              <p className="clr-pri-2">ትምህርታዊ ፕሮግራሞች</p>
                            </li>
                            <li className="st-2 fx">
                              <i className="fas fa-check" />
                              <p className="clr-pri-2">ኢትዮጵያዊ ስጦታዎች</p>
                            </li>
                            <li className="st-3 fx">
                              <i className="fas fa-check" />
                              <p className="clr-pri-2">የመዝናኛ ጨዋታዎች</p>
                            </li>
                          </ul>
                          <div className="box-btn">
                            <a href="" className="fl-btn st-12">
                              <span className="inner">ያግኙን</span>
                            </a>
                            <Link href="">
                              <a className="fl-btn st-1">
                                <span className="inner">እንተዋወቅ</span>
                              </a>
                            </Link>
                          </div>
                        </div>
                        <div className="box-feature">
                          <div className="image">
                            <img
                              src="assets/images/EthLijochImage/slider-1.png"
                              alt="Image"
                            />
                          </div>
                        </div>
