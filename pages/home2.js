                      ...
                      <div className="item-slider-2">
                        <div className="box-content">
                          ...
                          <div className="title clr-pri-2">
                            የነገዋን ኢትዮጵያ በልጆቻችን ማንነት ውስጥ እንገንባ
                          </div>
                          ...
                          <div className="btn-slider">
                            <Link href="/membership">
                              <a className="fl-btn st-2">
                                <span className="inner">የኢትዮጵያ ልጆች አባል ይሁኑ </span>
                              </a>
                            </Link>
                          </div>
                        </div>
                        <div className="sc-img fx">
                          <img
                            src="assets/images/EthLijochimage/imgslhome2.jpg"
                            alt=""
                          />
                        ...
                        <div className="box-feature">
                          <div className="image">
                            <img
                              src="assets/images/EthLijochimage/slider-2.jpg"
                              alt="Image"
                            />
                          </div>
                        </div>
